...
# This example mainly shows the learning process of DRL_Searcher combined with PTB, corresponding to Simulation2 in our paper.

# To be more specific. Here we take MuRES2 in the House environment as an example.
